...
public class JibNativeImageExtensionTest {
  ...
  @Mock private GraalVMExtension graalVMExtension;
  ...
  public void testGetExecutableName_property() {
    ...
    assertThat(JibNativeImageExtension.getExecutableName(project, jibContainer, properties))
  ...
  public void testGetExecutableName_imageName() {
    ...
    assertThat(JibNativeImageExtension.getExecutableName(project, jibContainer, new HashMap<>()))
        .isEqualTo(Optional.of("theExecutable"));
  }
  ...
  public void testGetExecutableName_mainClass() {
    //
    // when(project.getExtensions().findByType(GraalVMExtension.class)).thenReturn(graalVMExtension);
    //    NativeImageOptions nio = new MockNativeImageOptions();
    //    when(graalVMExtension.getBinaries().stream()
    //        .filter(e -> e.getName().equals("main"))
    //        .findFirst()).thenReturn(Optional.of(nio));
    //    when(nio.getMainClass().get()).thenReturn("mymain");
    //
    //    assertThat(JibNativeImageExtension.getExecutableName(project, jibContainer, new
    // HashMap<>()))
    //        .isEqualTo(Optional.of("mymain"));
  }
